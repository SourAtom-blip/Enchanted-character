        ...
        sections: [
          {
            ...
            type: 'text',
            heading: 'Our Story',
            body: "Lorrie's Enchanted Arts began with a simple belief: that magic, when done right, is a craft worthy of the same rigor as any fine art. For over a decade we have brought storybook characters to life for families, event planners, and collectors who value authenticity and artistry above all else.",
            order: 0,
          },
        ],
      },
        ...
        sections: [
          {
            ...
            body: 'Inquire today for character bookings, custom art commissions, or to plan your next magical event.',
            order: 0,
          },
        ],
      },
